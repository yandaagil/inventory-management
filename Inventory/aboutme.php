                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="jumbotron text-center">
                                    <img src="assets/img/DSC_4111 (2).jpg" style="width: 250px; border-radius: 50%;" class="img-thumbnail mb-4" alt="Profile Picture">
                                    <h1 class="display-4">Hello!</h1>
                                    <p class="lead">My name is Yanda Agil Marfani (L200190125).<br>I'm a student from Universitas Muhammadiyah Surakarta studying Informatics.</p>
                                </div>
                            </div>
                        </div>
                    </div>
